...
Downloads the current regulatory text for 5 CFR titles relevant to
EPA, FDA, USDA/APHIS, and FWS from GovInfo bulk data. Parses the XML
hierarchy into structured JSON for database import.

No API key required — direct file downloads from govinfo.gov.

Usage:
    python3 10_ecfr.py              # download all 5 titles
